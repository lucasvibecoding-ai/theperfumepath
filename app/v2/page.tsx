      ...
      <div className="bonsai-page">
        <div className="container">
          ...
          <section style={{ paddingTop: 64, paddingBottom: 48, textAlign: 'center' }}>
            ...
            <p className="hero-sub" style={{ color: 'var(--ink-muted)', marginTop: 8, maxWidth: 600, marginLeft: 'auto', marginRight: 'auto', fontStyle: 'italic' }}>You don&apos;t need a garden. You don&apos;t need talent. You need a $12 tree, a pair of shears, and 20 minutes.</p>
